...
void Map::init()
{
    groundland = loadBMP("Resources\\Textures\\ground.bmp");
    skymap = loadBMP("Resources\\Textures\\sky.bmp");
    nightSkymap = loadBMP("Resources\\Textures\\nightSky.bmp");
    brickwallmap = loadBMP("Resources\\Textures\\brickwall.bmp");
	winnermap = loadBMP("Resources\\Textures\\winner.bmp");
