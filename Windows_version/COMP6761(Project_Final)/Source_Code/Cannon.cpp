...
{
    metal = loadBMP("Resources\\Textures\\metal.bmp");
    wheel = loadBMP("Resources\\Textures\\wheel.bmp");
    gunpeel = loadBMP("Resources\\Textures\\gun.bmp");
    wood = loadBMP("Resources\\Textures\\box.bmp");
    gun_rust = loadBMP("Resources\\Textures\\gun_rust.bmp");
    smoke   = loadBMP("Resources\\Textures\\smoke.bmp");
